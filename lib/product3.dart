  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(leading: IconButton(onPressed: () {
        ...
        backgroundColor: Color.fromARGB(255, 208, 89, 91),actions: [IconButton(onPressed: () {
      ...
      body: Stack(
        children: [
                      ...
                      child: Row(
                        children: [
                          Container(
                              ...
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(15),
                                  border: Border.all(color: Color.fromARGB(255, 208, 89, 91))),
                              child:const Icon(Icons.add_shopping_cart_outlined,color: Color.fromARGB(255, 208, 89, 91),)
                          ),Padding(
                            ...
                            child: Expanded(
                              child: Container(
                                ...
                                width: 280,
                                decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(15),color: Color.fromARGB(255, 208, 89, 91)),
                                child: const Center(
                                    child: Text(
                                      'BUY NOW',
                                      style: TextStyle(
          ...
          Padding(
            ...
            child: Image.asset('assets/bag.png',width: 200,
              height: 200,),
