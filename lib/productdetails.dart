  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(leading: IconButton(onPressed: () {
        ...
        backgroundColor: Color.fromARGB(255, 39, 98, 137),actions: [IconButton(onPressed: () {
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(15),
                                border: Border.all(color: Color.fromARGB(255, 39, 98, 137),)),
                            child:Icon(Icons.add_shopping_cart_outlined,color: Color.fromARGB(255, 39, 98, 137),)
                          ),Padding(
                            padding: const EdgeInsets.only(left: 20),
                            child: Expanded(
                              child: Container(
                                ...
                                width: 280,
                                decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(15),color: Color.fromARGB(255, 39, 98, 137),),
                                child: Center(
                                    child: Text(
                                      'BUY NOW',
                                      style: TextStyle(
